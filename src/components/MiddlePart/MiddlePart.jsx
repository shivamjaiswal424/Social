        ...
        <div className='px-20'>
            ...
            <Card className='p-5 mt-5'>
                <div className="flex justify-between">
                    ...
                    readOnly 
                    type="text" className="outline-none w-[90%] rounded-full px-5 bg-transparent border border-[#3b4054]" />
                </div>
                <div className="flex justify-center space-x-9 mt-5">
                    <div className="flex items-center">
                        <IconButton color="secondary" onClick={handleOpenCreatePostModel}>
                            <ImageIcon />
                        </IconButton>
                        <span>Media</span>
                    </div>
